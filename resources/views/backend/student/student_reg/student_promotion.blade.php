                        ...
                        <div class="form-group">
                          <div class="controls">
                            ...
                            <select name="gender" id="gender" required class="form-control">
                              ...
                              <option value="Male" {{($editData['student']['gender'] == "Male")?'selected':""}}>Male
                              </option>
                        ...
                        <div class="form-group">
                          <div class="controls">
                            ...
                            <select name="religion" id="gender" required class="form-control">
                              ...
                              <option value="Hindu" {{($editData['student']['religion'] == "Hindu")?'selected':""}}>
                                Hindu</option>
                              <option value="Buddhist"
                                {{($editData['student']['religion'] == "Buddhist")?'selected':""}}>Buddhist</option>
                              <option value="Christian"
                                {{($editData['student']['religion'] == "Christian")?'selected':""}}>Christian</option>
                              <option value="Islam" {{($editData['student']['religion'] == "Islam")?'selected':""}}>
                                Islam</option>
